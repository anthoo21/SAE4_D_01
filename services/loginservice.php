...
class LoginService {
    ...
    public static function getUser($login, $password) {
        $apiUrl="http://dolibarr.iut-rodez.fr/G2022-63/htdocs/api/index.php/login?login=".$login."&password=".$password;
    ...
    public static function getArticles() {
        $apiKey="4p88X53cm664lX8lXahVFdnpRUVJM1iA";
        $apiUrl="http://dolibarr.iut-rodez.fr/G2022-63/htdocs/api/index.php/products?sortfield=t.ref&sortorder=ASC&limit=100";
